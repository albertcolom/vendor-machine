...
class AddCoinVendingMachineTest extends TestCase
{
    ...
    public function testItShouldGetInvalidCoinExceptionWhenInsertInvalidCoinType(): void
    {
        ...
        $sut = new AddCoinVendingMachine($this->mocked_vending_machine_repository);
        $sut->handle(new AddCoinVendingMachineCommand(self::INVALID_COIN));
    }
    ...
    public function testItShouldInsertCoinOnUserWallet(): void
    {
        ...
        $sut = new AddCoinVendingMachine($this->mocked_vending_machine_repository);
        $sut->handle(new AddCoinVendingMachineCommand(self::VALID_COIN));
    }
    ...
    public function testItShouldSumMoneyWhenCoinExistInWallet(): void
    {
        ...
        $expected_vending_machine->addMachineCoin(Coin::withOne());
